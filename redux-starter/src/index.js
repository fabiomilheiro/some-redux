...
console.log(
  "Bugs for user 1",
  users.selectors.getUsersWithoutBugsAssigned(store.getState())[1]
);
console.log(
  "Bugs for user 2",
  users.selectors.getUsersWithoutBugsAssigned(store.getState())[2]
);
console.log(
  "Bugs for user 3",
  users.selectors.getUsersWithoutBugsAssigned(store.getState())[3]
);
